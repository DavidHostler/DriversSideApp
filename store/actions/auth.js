...
export const signup = (email, password) => {
  return async dispatch => {
    const response = await fetch(
      ...
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyC6nh5X3ku1mdoWaCFAJX3ouEtIKkJBhow',
      {
        method: 'POST',
        headers: {
...
export const login = (email, password) => {
  return async dispatch => {
    const response = await fetch(
      ...
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyC6nh5X3ku1mdoWaCFAJX3ouEtIKkJBhow',
      {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
